...
namespace Floobits.Common
{
    public class InboundRequestHandler
    {
        ...
        private void initialManageConflicts(RoomInfoResponse ri)
        {
            ...
            string[] conflictedPathsArray = new string[conflictedPaths.Count];
            ...
            Action stompLocal = new Action(conflictwork.stompLocalWork);
            Action stompRemote = new Action(conflictwork.stompRemoteWork);
            Action flee = new Action(conflictwork.fleeWork);
        ...
        void _on_msg(JObject jsonObject)
        {
            ...
            JToken jtime = jsonObject.SelectToken("time");
            ...
            {
                double time = jtime.ToObject<double>();
                messageDate = new DateTime(1970, 1, 1, 0, 0, 0, 0, System.DateTimeKind.Utc);
                messageDate.AddSeconds(time);
            }
        ...
        public void _on_highlight(JObject obj)
        {
            ...
            bool force = !res.following && (res.ping || res.summon);
